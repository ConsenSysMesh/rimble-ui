...
storiesOf('Tooltip', module)
  ...
  .add(
    ...
    <Text>They're for extra information that some might find useful but don't necessarily need to be on the interface for everyone. The content should never provide critical information that will impact a user's ability to use your product. For example, if you hover over a piece of UI that indicates your network status...</Text><br />

    <Flex>
      <Card mx={'auto'} my={3} px={4} width="400px">
        <Pill mb={3} color={"green"}>{"Do"}</Pill><br />
        <Tooltip placement="right" variant="dark" message="You're on the Rinkeby network">
        <TextButton icon="Check">Right network</TextButton>
        </Tooltip>
    </Card>
      <Card mx={'auto'} my={3} px={4} width="400px">
        <Pill mb={3} color={"red"}>{"Don't"}</Pill><br />
        <Tooltip placement="right" variant="dark" message="To use this dApp you must be on the Rinkeby network">
    ...
    <Text>Tooltips are for elaboration. Labels next to UI elements are always better than tooltips as it is not always clear that tooltips are there. And it's not always possible to hover.</Text><br />
    ...
    <Box>
    <Heading.h4>Some suggested uses</Heading.h4><br />
<Tooltip placement="bottom" variant="light" message="0x99cb784f0429efd72wu39fn4256n8wud4e01c7d2"><Pill>{'0x99...7d2'}</Pill>
</Tooltip><br /><br />

    <Text>This will include a small <Tooltip message="This pays for your transaction to be added to the blockchain"><strong>transaction fee</strong></Tooltip> which we'll include in your transaction summary</Text>
    </Box>
    </Box>
    <br /><br />
