...
icon={'Mood'}
    ...
    <ul>
    <li><Text>They dismiss automatically</Text></li>
    <li><Text>User can dismiss them manually</Text></li>
    <li><Text>They display one at a time, so if multiple messages are necessary, each one should appear after the previous message.</Text></li>
    </ul>
    </Box><br />
    <Box>
    ...
    <Text.p>Toasts should steer clear of navigational elements and important areas of the screen. Consider that the MetaMask browser extension could potentially hide your toast messages.</Text.p>
    </Box><br />
    <Box>
    ...
    <Text>Some best practices for writing <code>{'ToastMessage'}</code>s.</Text>
    </Box>
    <Box>
